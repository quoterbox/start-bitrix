...
if ($arResult['type'] == 'feedback_form_init'):?>

    <form class="feedback_modal_form simple_form" action="" data-action="feedback_form_action">
...
elseif($arResult['type'] == 'feedback_form_success'):?>
